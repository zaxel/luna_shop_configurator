...
import TShirt3DModelScene from '../TShirt3DModelScene';
import DecalTrigger from '../DecalTrigger';

type ProductCardProps = {
    item: products.Product;
};

const Product3DCustomizer = ({ item }: ProductCardProps) => {
...
export default Product3DCustomizer